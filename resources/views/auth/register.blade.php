<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('layouts.auth.name')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('layouts.auth.password')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('layouts.auth.confirmpass')" />
