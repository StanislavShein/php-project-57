    ...
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="grid col-span-full">
            ...
            <div class="flex flex-col">
                ...
                <div class="mt-2 text-black">
                    {{ Form::text('description', null, ['name' => 'description']) }}
                </div>
                ...
                <div class="mt-2 text-black">
                    {{ Form::text('status_id', null, ['name' => 'status_id']) }}
                </div>

                <div>
                    {{ Form::label('created_by_id', __('layouts.tasks.executor')) }}
                </div>
                <div class="mt-2 text-black">
                    {{ Form::text('created_by_id', null, ['name' => 'created_by_id']) }}
                </div>
